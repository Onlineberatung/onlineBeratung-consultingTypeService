...
public class ConsultingTypePaginationLinksBuilderTest {
  ...
  public void buildPaginationLinks_Should_returnPaginationLinks_When_allParametersAreSet() {
    ...
    List<ExtendedConsultingTypeResponseDTO> randomConsultingTypeResultDTOList = easyRandom
        .objects(ExtendedConsultingTypeResponseDTO.class, NUMBER_OF_CONSULTING_TYPES).collect(
            Collectors.toList());
