...
class ConsultingTypeGroupRepositoryImplTest {
  ...
  void getConsultingTypesGroupMap_Should_ReturnMapWithConsultingTypeGroups() {
    ...
    assertThat(result.get(GROUP_1)).contains(consultingType1);
    assertThat(result.get(GROUP_1)).contains(consultingType2);
